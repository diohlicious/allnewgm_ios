...
class _LoginState extends State<Login> {
  ...
  void  _onLoading() async {
    ...
    var response = await apiService.loginMobile(myEmail.text, myPassword.text) ;
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    ...
                    child: new Container(
                      ...
                      child: new Center(child: new Text('Masuk', style: new TextStyle(fontWeight: FontWeight.w500,fontSize: 18.0, color: Colors.white),),),
                    ),
                  ),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text("Belum mempunyai akun ? ", textAlign: TextAlign.center,style: TextStyle(
                  ...
                  FlatButton(
                    ...
                    }, child: Text("Daftar", textAlign: TextAlign.center,style: TextStyle(
                      fontWeight: FontWeight.w500,
                      color: Color.fromARGB(255,148,193,44),
  ...
  Widget _showSignIn(context) {
    return Column(
      ...
      children: <Widget>[
        Text("Masuk", textAlign: TextAlign.center,style: TextStyle(
            fontWeight: FontWeight.w500,
            fontSize: 20)),
        SizedBox(
          height: 20,
        ),
        Text("Selamat datang silahkan masukan akun anda", textAlign: TextAlign.center,style: TextStyle(
            fontWeight: FontWeight.w500,
            fontSize: 14, color: Color.fromARGB(255, 143, 143, 143))),
        SizedBox(
          height: 40,
        ...
        Container(
          child:  FlatButton(
                 ...
                 //Navigator.of(context).pushNamed('/ubah');
                  if ( App.isEmail(myEmail.text) ){
                    App.newProses(context, () async {
                      ...
                      Navigator.of(context).pushNamed('/checksms', arguments :{'email' : myEmail.text});
                    });
                  }else{
            ...
            child: Text("Lupa Password ", textAlign: TextAlign.center,style: TextStyle(
              fontWeight: FontWeight.w500,color: Color.fromARGB(255,148,193,44),
              fontSize: 14)),),
