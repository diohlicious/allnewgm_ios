...
*/
  void _onNext() async {
    fileKtp == null
        ? App.showDialogBox(context, "Mohon Foto KTP", "", onClick: () async {
            Navigator.of(context).pop();
          })
        : fileSelfie == null
            ? App.showDialogBox(context, "Mohon Foto Selfie", "",
                onClick: () async {
                Navigator.of(context).pop();
              })
            : Navigator.of(context)
                .pushNamed('/alamat', arguments: {"daftarNson": daftarNson});
  }
          ...
          child: Padding(
            ...
            child: InkWell(
              onTap: () {
                print('hello');
                //Navigator.of(context).pop();
                //Navigator.of(context).pushNamed('/alamat', arguments: {"daftarNson",daftarNson});
                _onNext();
              },
              child: new Container(
                width: 100.0,
                ...
                GestureDetector(
                  onTap: () async {
                    Navigator.of(context)
                        ...
                        .then((value) => setState(() {
                              fileKtp = File(value);
                              List<int> imageBytes = fileKtp.readAsBytesSync();
                              String base64Image = base64Encode(imageBytes);
                              daftarNson.set("photoktp",
                ...
                GestureDetector(
                  onTap: () async {
                    await Navigator.of(context)
                        .pushNamed('/take')
                        .then((value) => setState(() {
                              fileSelfie = File(value);
                              List<int> imageBytes = fileKtp.readAsBytesSync();
                              String base64Image = base64Encode(imageBytes);
                              daftarNson.set("photoselfiektp",
                                  'data:image/jpeg;base64,$base64Image');
                              print(daftarNson.asString());
                            }));
                  },
