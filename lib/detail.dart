...
class _DetailState extends State<Detail> {
              ...
              appBar: AppBar(
                ...
                actions:  [
                  IconButton(
                    icon:
                    CircleAvatar(
                      child:  Icon(nPopulate.get("is_favorite").asInteger() ==1 ? Icons.favorite: Icons.favorite_border),
                      backgroundColor: Colors.white,
                      foregroundColor: nPopulate.get("is_favorite").asInteger() ==1 ? Colors.red : Colors.grey,),
                    /* Image.asset(
                ...
                fit: BoxFit.cover,
                    ...
                    onPressed: () {
                      ...
                      setFavUnFav(nPopulate, nPopulate.get("is_favorite").asInteger());
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      args.set("start_date", nPopulate.get("start_date").asString());
  ...
  List<Widget> getChilds(String key){
    ...
    for (var i = 0; i < nPopulate.get(key).size(); i++) {
      children.add(textViewIcon(context, nPopulate.get(key).getIn(i).get("item").asString(), nPopulate.get(key).getIn(i).get("description").asString(),  nPopulate.get(key).getIn(i).get("status").asString() == '1') );
    }
    return children;
  }
  List<Widget> getChildsImage( ){
    ...
    for (var i = 0; i < nPopulate.get(key).size(); i=i+2) {
      children.add(imageViewOnly(nPopulate.get(key).getIn(i), i+1 >= nPopulate.get(key).size() ? Nson(null) : nPopulate.get(key).getIn(i +1 < nPopulate.get(key).size()?i+1:i))  );
    }
      ...
      children: <Widget>[
        ...
        Align(
          ...
          Container(
            ...
            child:
          Text(nPopulate.get("vehicle_name").asString(),
          ...
          Align(
            ...
            child: CircleAvatar(
              child: Text(nPopulate.get("grade").asString(),
                style: TextStyle(
        ...
        Row(children: [
          Text(nPopulate.get("kik").asString(),style:
          TextStyle(
...
//nPopulate.get("kik").asString()
        ...
        Stack(
          children: [
            Text(
              'Rp.' + App.formatCurrency(nPopulate.get("open_price").asDouble()),
       ...
       Container(
         ...
         new PageView.builder(
             ...
             itemBuilder: (context, index) => _carouselBuilder(index, controller,
                 InkWell(
                   onTap: (){
                     showImage(mySLides.getIn(index).get("description").asString(), mySLides.getIn(index).get("url_image").asString(), mySLides, index );
                   },
                   child: Container(
                     ...
                     decoration:  BoxDecoration(
                       ...
                       image: DecorationImage(
                         image: NetworkImage(mySLides.getIn(index).get("url_image").asString()),
        ...
        Text(nPopulate.get("vehicle_summary").asString().replaceAll(",", "\r\n-"),  style:  TextStyle(  fontSize: 18, height: 1.3)   ),
       /* SizedBox(  height:10, ),
        ...
        children: [
              ExpansionPanel(
                  ...
                  body: Column(children: [
                    textViewOnly(context, "ID Nomor", nPopulate.get("vehicle_data").get("id_nomor").asString()),
                    textViewOnly(context, "No. Polisi	", nPopulate.get("vehicle_data").get("nomor_polisi").asString()),
                    textViewOnly(context, "Skor", nPopulate.get("vehicle_data").get("grade").asString()),
                    textViewOnly(context, "Year", nPopulate.get("vehicle_data").get("tahun").asString()),
                    textViewOnly(context, "Transmition", nPopulate.get("vehicle_data").get("transmisi").asString()),
                    textViewOnly(context, "Color", nPopulate.get("vehicle_data").get("color").asString()),
                    textViewOnly(context, "KM", nPopulate.get("vehicle_data").get("km").asString()),
                    textViewOnly(context, "Kepemilikan", nPopulate.get("vehicle_data").get("kepemilikan").asString()),
                    textViewOnly(context, "lokasi", nPopulate.get("vehicle_data").get("lokasi").asString()),
                    textViewOnly(context, "Stnk", nPopulate.get("vehicle_data").get("stnk").asString()),
          ...
          ExpansionPanel(
            ...
            body: Column(children: getChilds("vehicle_interior") /*[
          ...
          ExpansionPanel(
            ...
            body: Column(children: getChilds("vehicle_mesin")/* [
              textViewIcon(context, "Power Window", "OK", true),
              textViewIcon(context, "Electric Mirror", "OK", true),
          ...
          ExpansionPanel(
            ...
            body:  Column(children: getChildsImage()/* [
        ...
        children: [
          Column(
            children: [
              ...
              InkWell(
                onTap: (){
                  showImage(imag1.get("description").asString(), imag1.get("url_image").asString(),
                      imagList,
                      0);
                },
                child: Container(
          ...
          Column(
            children: [
              imag2.isNull()? Container( width: 150,  height: 120,):
              InkWell(
                onTap: (){
                  showImage(imag2.get("description").asString(), imag2.get("url_image").asString(), imagList, 1);
                },
                child:  Container(
                  alignment: Alignment.center,
                  width: 150,
